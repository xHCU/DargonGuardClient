...
public class Encryption {
	...
	public String encrypt(String string, String secret) {
		try {
			...
			if (getDay()) {
				string = new Encryption3().encryptXORBase64(string);
			} else {
				string = new Encryption2().encryptXORBase64(string);
			}
	...
	public String decrypt(String string, String secret) {
		try {
			...
			if (getDay()) {
				result = new Encryption2().decryptXORBase64(result);
			} else {
				result = new Encryption3().decryptXORBase64(result);
			}
